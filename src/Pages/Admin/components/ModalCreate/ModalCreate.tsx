    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black bg-opacity-50 p-4">
      <div className="relative max-h-[90vh] w-full max-w-2xl">
        ...
        <div className="relative overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
          {/* Modal header */}
          <div className="sticky top-0 z-10 flex items-start justify-between rounded-t border-b bg-white p-4 dark:border-gray-600">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-8 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                      required
              ...
              <div>
                ...
                <div className="flex w-full items-center justify-center">
                  <label className="flex h-32 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-700">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
                      {images.map((image, index) => (
                        <div key={index} className="group relative">
                          <div className="truncate rounded-lg bg-gray-100 p-2 text-xs dark:bg-gray-700">
                            {image.name}
                          </div>
                          <button
                            type="button"
          ...
          {/* Modal footer */}
          <div className="sticky bottom-0 flex items-center space-x-2 rounded-b border-t border-gray-200 bg-white p-6 dark:border-gray-600 dark:bg-gray-800">
            <button
              type="submit"
              onClick={handleSubmit}
              disabled={isLoading}
              className="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              {isLoading ? (
                <>
                  <svg
